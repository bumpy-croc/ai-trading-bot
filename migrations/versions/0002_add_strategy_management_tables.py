...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_strategy_registry_parent_id",
        "strategy_registry",
        "strategy_registry",
        ["parent_id"],
        ["strategy_id"],
    ...
    op.create_index(
        op.f("ix_strategy_registry_strategy_id"), "strategy_registry", ["strategy_id"], unique=False
    )
    op.create_index(op.f("ix_strategy_registry_name"), "strategy_registry", ["name"], unique=False)
    op.create_index(
        op.f("ix_strategy_registry_created_at"), "strategy_registry", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_strategy_registry_parent_id"), "strategy_registry", ["parent_id"], unique=False
    )
    op.create_index(
        op.f("ix_strategy_registry_config_hash"), "strategy_registry", ["config_hash"], unique=False
    )
    op.create_index(
        op.f("ix_strategy_registry_component_hash"),
        "strategy_registry",
        ["component_hash"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_version_strategy_created", "strategy_versions", ["strategy_id", "created_at"]
    )
    op.create_index(
        op.f("ix_strategy_versions_strategy_id"), "strategy_versions", ["strategy_id"], unique=False
    )
    op.create_index(
        op.f("ix_strategy_versions_created_at"), "strategy_versions", ["created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "signal_generator_contribution", sa.Numeric(precision=18, scale=8), nullable=True
        ),
    ...
    op.create_index(
        "idx_perf_strategy_period",
        "strategy_performance",
        ["strategy_id", "period_start", "period_end"],
    )
    op.create_index(
        "idx_perf_return_sharpe", "strategy_performance", ["total_return_pct", "sharpe_ratio"]
    )
    op.create_index("idx_perf_period_type", "strategy_performance", ["period_type", "period_start"])
    op.create_index(
        op.f("ix_strategy_performance_strategy_id"),
        "strategy_performance",
        ["strategy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_strategy_performance_period_start"),
        "strategy_performance",
        ["period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_strategy_performance_period_end"),
        "strategy_performance",
        ["period_end"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_lineage_ancestor", "strategy_lineage", ["ancestor_id", "generation_distance"]
    )
    op.create_index(
        "idx_lineage_descendant", "strategy_lineage", ["descendant_id", "generation_distance"]
    )
    op.create_index(
        op.f("ix_strategy_lineage_ancestor_id"), "strategy_lineage", ["ancestor_id"], unique=False
    )
    op.create_index(
        op.f("ix_strategy_lineage_descendant_id"),
        "strategy_lineage",
        ["descendant_id"],
        unique=False,
    )
