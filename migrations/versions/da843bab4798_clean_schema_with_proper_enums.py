"""clean_schema_with_proper_enums

Revision ID: da843bab4798
Revises: 
Create Date: 2025-09-04 14:09:56.226302
...
def upgrade() -> None:
    """Create complete schema with proper enum handling"""

    # Create enum types conditionally (only if they don't exist)
    enum_definitions = [
