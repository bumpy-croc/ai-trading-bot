...
def upgrade() -> None:
    ...
    enum_definitions = [
        ...
        (
            "eventtype",
            "'ENGINE_START', 'ENGINE_STOP', 'STRATEGY_CHANGE', 'MODEL_UPDATE', 'ERROR', 'WARNING', 'ALERT', 'BALANCE_ADJUSTMENT', 'TEST'",
        ),
    ...
    op.create_index(
        "idx_corr_pair_updated", "correlation_matrix", ["symbol_pair", "last_updated"], unique=False
    )
    op.create_index(
        op.f("ix_correlation_matrix_symbol_pair"),
        "correlation_matrix",
        ["symbol_pair"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_portfolio_exposures_correlation_group"),
        "portfolio_exposures",
        ["correlation_group"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_pred_cache_model_config",
        "prediction_cache",
        ["model_name", "config_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_prediction_cache_cache_key"), "prediction_cache", ["cache_key"], unique=True
    )
    op.create_index(
        op.f("ix_prediction_cache_expires_at"), "prediction_cache", ["expires_at"], unique=False
    )
    op.create_index(
        op.f("ix_prediction_cache_features_hash"),
        "prediction_cache",
        ["features_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_prediction_cache_model_name"), "prediction_cache", ["model_name"], unique=False
    )
    ...
    op.create_index(
        "idx_pred_perf_model", "prediction_performance", ["model_name", "horizon"], unique=False
    )
    op.create_index("idx_pred_perf_time", "prediction_performance", ["timestamp"], unique=False)
    op.create_index(
        op.f("ix_prediction_performance_timestamp"),
        "prediction_performance",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_trading_sessions_start_time"), "trading_sessions", ["start_time"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_account_history_timestamp"), "account_history", ["timestamp"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "side",
            sa.Enum("LONG", "SHORT", name="positionside", native_enum=False, create_type=False),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("OPEN", "CLOSED", name="positionstatus", native_enum=False, create_type=False),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_order_position_type", "orders", ["position_id", "order_type"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_orders_internal_order_id"), "orders", ["internal_order_id"], unique=False
    )
    ...
    op.create_index(
        "idx_partial_trade_position", "partial_trades", ["position_id", "timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_partial_trades_position_id"), "partial_trades", ["position_id"], unique=False
    )
    op.create_index(
        op.f("ix_partial_trades_timestamp"), "partial_trades", ["timestamp"], unique=False
    )
    ...
    op.create_index(
        "idx_event_time_type", "system_events", ["timestamp", "event_type"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_trade_performance", "trades", ["pnl_percent", "strategy_name"], unique=False
    )
    ...
    op.create_index(
        "idx_dynamic_perf_session", "dynamic_performance_metrics", ["session_id"], unique=False
    )
    op.create_index(
        "idx_dynamic_perf_timestamp", "dynamic_performance_metrics", ["timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_dynamic_performance_metrics_timestamp"),
        "dynamic_performance_metrics",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_optimization_cycles_timestamp"), "optimization_cycles", ["timestamp"], unique=False
    )
    ...
    op.create_index(
        "idx_metrics_period", "performance_metrics", ["period", "period_start"], unique=False
    )
    op.create_index(
        op.f("ix_performance_metrics_period_start"),
        "performance_metrics",
        ["period_start"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_risk_adjustments_timestamp"), "risk_adjustments", ["timestamp"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_strategy_executions_timestamp"), "strategy_executions", ["timestamp"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_dynamic_performance_metrics_timestamp"), table_name="dynamic_performance_metrics"
    )
    ...
    op.drop_index(
        op.f("ix_portfolio_exposures_correlation_group"), table_name="portfolio_exposures"
    )
