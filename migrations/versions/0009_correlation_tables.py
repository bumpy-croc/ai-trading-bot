...
def upgrade() -> None:
	...
	if _table_exists("correlation_matrix") and not _index_exists("correlation_matrix", "idx_corr_pair_updated"):
		op.execute("CREATE INDEX IF NOT EXISTS idx_corr_pair_updated ON correlation_matrix (symbol_pair, last_updated)")
