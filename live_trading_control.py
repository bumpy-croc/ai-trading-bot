...
class LiveTradingController:
    ...
    def train_and_deploy_model(self, symbol: str = "BTCUSDT", 
                              with_sentiment: bool = False,
                              days: int = 365, epochs: int = 50,
        ...
        if auto_deploy:
            ...
            print(f"   python live_trading_control.py deploy-model --model-path {deployment_package['staging_path']}")
            return True
    ...
    def deploy_model(self, model_path: str, close_positions: bool = False) -> bool:
        ...
        deployment_package = {
            ...
            'strategy_name': 'ml_sentiment_strategy' if 'sentiment' in model_path else 'ml_model_strategy',
...
def main():
    ...
    train_parser.add_argument('--auto-deploy', action='store_true', help='Auto-deploy after training')
    ...
    deploy_parser.add_argument('--close-positions', action='store_true', help='Close positions before deploy')
    ...
    swap_parser.add_argument('--close-positions', action='store_true', help='Close positions before swap')
