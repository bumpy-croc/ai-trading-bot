...
from src.prediction.models.onnx_runner import OnnxRunner, ModelPrediction
...
class TestOnnxRunner:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='{"sequence_length": 120, "feature_count": 5}')
    ...
    def test_prediction_interface(self):
        ...
        with patch('pathlib.Path.glob', return_value=[]):
            ...
            mock_prediction = ModelPrediction(
                ...
                model_name="test", inference_time=0.01
            )
