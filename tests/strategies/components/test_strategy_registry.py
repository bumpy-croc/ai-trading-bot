...
class TestStrategyMetadata:
    ...
    def test_strategy_metadata_creation(self):
        ...
        risk_config = ComponentConfig("risk_manager", "FixedRiskManager", {"risk_per_trade": 0.02}, "1.0.0")
        sizer_config = ComponentConfig("position_sizer", "FixedFractionSizer", {"fraction": 0.05}, "1.0.0")
...
class TestStrategyRegistry:
    ...
    def test_update_strategy(self, registry, test_strategy):
        ...
        new_version = registry.update_strategy(strategy_id, updated_strategy, changes, is_major=False)
    ...
    def test_list_strategies(self, registry, test_strategy):
        ...
        strategy2 = Strategy("Strategy2", test_strategy.signal_generator, 
                           test_strategy.risk_manager, test_strategy.position_sizer)
        strategy3 = Strategy("Strategy3", test_strategy.signal_generator, 
                           test_strategy.risk_manager, test_strategy.position_sizer)
