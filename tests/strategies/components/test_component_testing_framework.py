...
def sample_regime_data():
    ...
    regime_data = pd.DataFrame({
        ...
        'regime_type': ['trend_up_low_vol'] * 50 + ['trend_up_high_vol'] * 50 + 
                      ['trend_down_high_vol'] * 50 + ['trend_down_low_vol'] * 50
    }, index=dates)
...
class TestComponentPerformanceTester:
    ...
    def test_random_signal_generator_testing(self, sample_test_data):
        ...
        assert results.buy_signals + results.sell_signals + results.hold_signals == results.total_signals
