...
class TestMarketData:
    ...
    def test_get_spread(self):
        ...
        market_data = MarketData(
            symbol="BTCUSDT", price=50000.0, volume=1000.0, bid=49950.0, ask=50050.0
        )
    ...
    def test_get_spread_missing_data(self):
        ...
        market_data = MarketData(symbol="BTCUSDT", price=50000.0, volume=1000.0)
...
class TestFixedRiskManager:
    ...
    def test_should_exit_no_exit(self):
        ...
        market_data = MarketData(symbol="BTCUSDT", price=52000.0, volume=1000.0)
    ...
    def test_should_exit_stop_loss_triggered(self):
        ...
        market_data = MarketData(symbol="BTCUSDT", price=47000.0, volume=1000.0)
...
class TestVolatilityRiskManager:
    ...
    def create_test_signal(
        self, direction=SignalDirection.BUY, strength=0.8, confidence=0.9, atr=None
    ):
    ...
    def test_volatility_risk_manager_initialization_custom(self):
        ...
        manager = VolatilityRiskManager(
            base_risk=0.03, atr_multiplier=1.5, min_risk=0.01, max_risk=0.08
        )
    ...
    def test_should_exit_volatility_based_stop(self):
        ...
        market_data = MarketData(
            symbol="BTCUSDT", price=47000.0, volume=1000.0, volatility=0.04  # 4% volatility
        )
...
class TestRegimeAdaptiveRiskManager:
    ...
    def create_test_regime(
        self, trend="trend_up", volatility="low_vol", confidence=0.8, duration=10
    ):
    ...
    def test_regime_adaptive_risk_manager_initialization_custom(self):
        ...
        custom_multipliers = {"bull_low_vol": 2.0, "bear_high_vol": 0.2}
        manager = RegimeAdaptiveRiskManager(base_risk=0.03, regime_multipliers=custom_multipliers)
        assert manager.base_risk == 0.03
    ...
    def test_partial_custom_multipliers_no_keyerror(self):
        ...
        manager = RegimeAdaptiveRiskManager(
            base_risk=0.02, regime_multipliers={"bull_low_vol": 2.0}  # Only one multiplier
        )
        signal = self.create_test_signal(SignalDirection.BUY, 0.8, 0.9)
        balance = 10000.0
    ...
    def test_should_exit_regime_based_stop(self):
        ...
        market_data = MarketData(symbol="BTCUSDT", price=47500.0, volume=1000.0)
    ...
    def test_should_exit_regime_transition(self):
        ...
        market_data = MarketData(symbol="BTCUSDT", price=50500.0, volume=1000.0)
