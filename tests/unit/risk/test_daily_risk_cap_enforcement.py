...
def test_daily_risk_cap_enforced_across_positions():
    ...
    f1 = rm.calculate_position_fraction(
        df=df, index=1, balance=10000, price=101.0, indicators={}, strategy_overrides=overrides
    )
    ...
    f2 = rm.calculate_position_fraction(
        df=df, index=2, balance=10000, price=102.0, indicators={}, strategy_overrides=overrides
    )
    ...
    f3 = rm.calculate_position_fraction(
        df=df, index=2, balance=10000, price=102.0, indicators={}, strategy_overrides=overrides
    )
    assert f3 == 0.0
