...
def test_daily_risk_cap_enforced_across_positions():
    ...
    f1 = rm.calculate_position_fraction(df, 2, balance=10_000, price=102, strategy_overrides=overrides)
    ...
    f2 = rm.calculate_position_fraction(df, 2, balance=10_000, price=102, strategy_overrides=overrides)
