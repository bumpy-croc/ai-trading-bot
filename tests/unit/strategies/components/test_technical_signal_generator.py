...
class TestTechnicalSignalGenerator:
    ...
    def create_regime_context(self, trend=TrendLabel.TREND_UP, volatility=VolLabel.LOW):
        ...
        return RegimeContext(
            trend=trend, volatility=volatility, confidence=0.8, duration=15, strength=0.7
        )
    ...
    def test_generate_signal_with_indicators(self):
        ...
        generator = TechnicalSignalGenerator(
            rsi_period=14, ma_short=10, ma_long=20, macd_fast=12, macd_slow=26, macd_signal=9
        )
    ...
    def test_get_parameters(self):
        ...
        generator = TechnicalSignalGenerator(
            name="test_tech", rsi_period=21, ma_short=15, ma_long=45
        )
...
class TestRSISignalGenerator:
    ...
    def test_rsi_signal_generator_initialization(self):
        ...
        generator = RSISignalGenerator(name="test_rsi", period=21, overbought=75, oversold=25)
    ...
    def test_get_parameters(self):
        """Test get_parameters method"""
        generator = RSISignalGenerator(name="custom_rsi", period=21, overbought=75, oversold=25)
...
class TestMACDSignalGenerator:
    ...
    def test_macd_signal_generator_initialization(self):
        ...
        generator = MACDSignalGenerator(
            name="test_macd", fast_period=10, slow_period=20, signal_period=5
        )
    ...
    def test_get_confidence(self):
        ...
        generator = MACDSignalGenerator()
        df = self.create_test_dataframe_with_macd(
            macd_values=[0.1], macd_signal_values=[0.0], macd_hist_values=[0.1]
        )
    ...
    def test_get_parameters(self):
        """Test get_parameters method"""
        generator = MACDSignalGenerator(
            name="custom_macd", fast_period=8, slow_period=21, signal_period=7
        )
