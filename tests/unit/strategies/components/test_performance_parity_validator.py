...
class TestToleranceConfig:
    ...
    def test_custom_values(self):
        ...
        config = ToleranceConfig(
            total_return_tolerance=0.05,
            sharpe_ratio_tolerance=0.2,
...
class TestPerformanceParityValidator:
    ...
    def test_compare_return_metrics(self, validator, sample_backtest_data):
        ...
        return_metrics = [comp for comp in report.metric_comparisons 
    ...
    def test_compare_risk_metrics(self, validator, sample_backtest_data):
        ...
        risk_metrics = [comp for comp in report.metric_comparisons 
                       if comp.metric_type == MetricType.RISK]
    ...
    def test_compare_efficiency_metrics(self, validator, sample_backtest_data):
        ...
        efficiency_metrics = [comp for comp in report.metric_comparisons 
                             if comp.metric_type == MetricType.EFFICIENCY]
