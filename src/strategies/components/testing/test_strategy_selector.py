...
class TestStrategySelector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = SelectionConfig(min_trades_for_consideration=10, min_days_active=5)
    ...
    def _create_mock_strategies(self) -> dict:
        ...
        self._populate_tracker(
            strategy1, sharpe_target=2.0, return_target=0.15, drawdown_target=0.08
        )
        ...
        self._populate_tracker(
            strategy2, sharpe_target=1.2, return_target=0.25, drawdown_target=0.15
        )
        ...
        self._populate_tracker(
            strategy3, sharpe_target=1.5, return_target=0.10, drawdown_target=0.05
        )
        ...
        self._populate_tracker(
            strategy4, sharpe_target=0.3, return_target=0.02, drawdown_target=0.25
        )
