...
class TestPerformanceMonitoringSystemIntegration(unittest.TestCase):
    ...
    def _populate_strategy_performance(
    ...
    def test_callback_registration(self):
        ...
        self.assertIn(
            approval_callback, self.monitoring_system.emergency_controls.approval_callbacks
        )
        self.assertIn(
            pre_switch_callback, self.monitoring_system.strategy_switcher.pre_switch_callbacks
        )
        self.assertIn(
            post_switch_callback, self.monitoring_system.strategy_switcher.post_switch_callbacks
        )
