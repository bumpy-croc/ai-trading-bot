...
class TestEmergencyControls(unittest.TestCase):
    ...
    def test_check_emergency_conditions_none(self):
        ...
        metrics = self._create_performance_metrics(
            max_drawdown=0.08, consecutive_losses=2  # Below thresholds
        )
    ...
    def test_check_emergency_conditions_high_drawdown(self):
        ...
        metrics = self._create_performance_metrics(
            max_drawdown=0.18, consecutive_losses=2  # Above high threshold
        )
        self.performance_tracker.get_performance_metrics.return_value = metrics
    ...
    def test_check_emergency_conditions_critical_drawdown(self):
        ...
        metrics = self._create_performance_metrics(
            max_drawdown=0.28, consecutive_losses=2  # Above critical threshold
        )
        self.performance_tracker.get_performance_metrics.return_value = metrics
    ...
    def test_check_emergency_conditions_consecutive_losses(self):
        ...
        metrics = self._create_performance_metrics(
            max_drawdown=0.08, consecutive_losses=6  # Normal drawdown  # Above threshold
        )
        self.performance_tracker.get_performance_metrics.return_value = metrics
    ...
    def test_request_manual_strategy_switch_bypass_approval(self):
        ...
        request_id = self.emergency_controls.request_manual_strategy_switch(
            "strategy_a", "strategy_b", "Emergency switch", "test_user", bypass_approval=True
        )
    ...
    def test_approve_request_rejection(self):
        ...
        # Reject the request
        result = self.emergency_controls.approve_request(request_id, "approver", "Not suitable")
    ...
    def test_alert_history_immediate_add(self):
        ...
        alert_id = fresh_controls._trigger_alert(
            AlertType.PERFORMANCE_DEGRADATION, EmergencyLevel.MEDIUM, "test_strategy", "Test alert"
        )
