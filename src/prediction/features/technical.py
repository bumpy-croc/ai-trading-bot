...
from src.config.constants import (
    DEFAULT_SEQUENCE_LENGTH, DEFAULT_NORMALIZATION_WINDOW,
    DEFAULT_RSI_PERIOD, DEFAULT_ATR_PERIOD, DEFAULT_BOLLINGER_PERIOD,
    DEFAULT_BOLLINGER_STD_DEV, DEFAULT_MACD_FAST_PERIOD, DEFAULT_MACD_SLOW_PERIOD,
    DEFAULT_MACD_SIGNAL_PERIOD, DEFAULT_MA_PERIODS
)
...
class TechnicalFeatureExtractor(FeatureExtractor):
    ...
    def extract(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            raise RuntimeError(f"Technical feature extraction failed: {str(e)}")
    ...
    def get_derived_features(self) -> List[str]:
        ...
        return [
            'returns', 'volatility_20', 'volatility_50', 
