...
- **daemon(PM) — over-confident on recall, strong on process design and self-correction.** Repeated a figure withdrawn six weeks earlier as live evidence framing a Board decision, then self-caught and logged the correction the same day. The **reproduce-first clause it wrote into the dispatch is the single control that caught all three bad numbers** — the practice is vindicated; the recall is not.
...
Ref: PR #1074, #1073, #1072, #1069, #1060, #1052, #1066; GH #1070/#1075/#1077/#1071/#1059/#1051/#1053/#1050/#1049/#1036/#1024/#1020/#845; [D-2026-08-13-01] through [D-2026-08-13-06], [D-2026-08-10-01]; .claude/LESSONS.md §1.10a/§2.9(e)/§2.13/§2.14/§3; .claude/skills/{weekly-retro,delegation-protocol,pm-session-boot}
