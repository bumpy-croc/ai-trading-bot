...
- **§3** (three bullets) — shared-venv bullet rewritten (+ the relative-path `grep`/`sed` variant); dead-task bullet **premise-corrected** (the six unregistered directories are deliberate retirements per Alex on #1050, not the 12-day outage the 08-10 retro reported) with the operational consequence that the standup is now the sole watchdog at ~24h latency; new bullet for quota-exhaustion kills and the catch-up-burst `lastRunAt` artifact.
...
Ref: PR #1074, #1073, #1072, #1069, #1060, #1052, #1066; GH #1070/#1075/#1071/#1059/#1051/#1053/#1050/#1049/#1036/#1024/#1020/#845; [D-2026-08-13-01] through [D-2026-08-13-06], [D-2026-08-10-01]; .claude/LESSONS.md §1.10a/§2.9(e)/§2.13/§2.14/§3; .claude/skills/{weekly-retro,delegation-protocol,pm-session-boot}
